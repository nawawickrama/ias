...
<div class="row">
    <div class="column1">
        <p class="arial">This is the initial assessment result of you and this is not the admission letter. In order to
            receive the Admission Acceptance Form (AAF), complete documents must be sent to the college as per the
            guidelines stipulated in our official website (www iaos de). Only upon receiving the complete documents the
...
<div class="row">
    <div class="column1">
        <img src="public/assets/images/txt.png" alt="image loading.." width="30%" height="30%">
