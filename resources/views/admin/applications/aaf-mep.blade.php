...
<head>
    ...
    <title>MEP - Admission Acceptance Form</title>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            ...
                            Thank you very much for your recent application (WS 2021) to study Master Eligibility Program (MEP) offered by IAS College in cooperation with partners. We are pleased to inform you that your application & admission to the contact study program has been successful and that you have received the following offer:
                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                        Duration: 7 months master eligibility program (MEP) at IAS College Campus in Germany + 2 years of master studies at a German University. Please do sign and return the acceptance form within 7 days. If you have any queries regarding this offer please feel free to contact us by Email admissions@iaos.de. The MEP program is done in prior to start of your Master studies.                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                        Once you have accepted your admission offer, we require you to pay the non-refundable administration fee of 1.000€ at the latest on or before «Zahlungsfrist_für_AAF». The remaining fee (3.000€) will be due within 7 days of a successful visa stamping & prior to landing in Germany. We are unable to issue your Original Admission letter for the MEP and the Master study offer letter with the prerequisite conditions (Vorläufigezulassung oder Zulassungsbescheid) until the administration fees has been paid and a valid Certificate B1 (Goethe, Telc or Ösd or IAS College Internal exam) has been submitted & other rules and regulations followed. It is important that to start your Master studies a C1 University level certification is a must (DSH or Telc C1 HS)  and this could be obtained by successfully completing the Master Eligibility Program (MEP). It is important to make sure your payment, your certificates and other necessary documents reaches us on time for a smooth admission & visa process and for you to join your course on time.                         </p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                        Details regarding your course start date, travel, Insurance and accommodation will be sent to you once your visa for Germany has been approved                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 border">
                        <p class="mt-4">
                        To receive your original duly signed Admission letter & to obtain the Master offer letter with the prerequisite conditions (Vorläufigezulassung/Zulassungsbescheid) you will need to:-                        </p>
                        <p>
                        ...
                        <b><u>To start the Master Eligibity Program (MEP) in Germany:</u></b><br>
                        D) Make remaining fees payment of 3.000€ towards your course fees within 7 days of successful Visa stamping & before arrival in Germany.<br>
                        <b><u>And to start the Master Studies:</u></b><br>
                        E) Complete MEP successfully<br>
                        </p>
                        <p>
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <p class="mt-4">
                            <b>3)</b> Original Admission letter for the MEP and the Master study offer letter with the prerequisite conditions (Vorläufigezulassung oder Zulassungsbescheid) cannot be provided until the administration fees has been paid and a valid Certificate B1 (Goethe, Telc or Ösd or IAS College Internal exam) has been submitted & other rules and regulations followed. This B1 certificate must be provided minimum 2 months prior to start of the program in Germany. The B1 certificate must not be more than 6 months old (in case the certain modules were passed on different dates, the first module exam pass date will be considered). Language Level evaluation tests from IAS college is also possible to ensure the B1 language level if the candidate cannot provide a new B1 certificate from Goethe, Telc or Ösd or from IAS College internal exam.
                            In case of not able to join the semester or the year for which this AAF has been provided, candidates are eligible for the immediate next intake for an additional administration fee of 150 Euros. Admission to any further intakes the candidate must reapply again. It is important that to start the Master studies a C1 Level German for University studies is  a must and is obtained by successfully completing the Master Eligibility Program (MEP).
                        </p>
                        <p class="mt-4">
