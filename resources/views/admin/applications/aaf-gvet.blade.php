        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            ...
                            Thank you very much for your recent application (T2022) for the German Vocational Education and Training (GVET) AZUBI program offered by IAS College in cooperation with partners. We are pleased to inform you that your application & admission to the GVET program has been successful and that you have received the following offer:
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            Once you have accepted your admission offer, we require you to pay the non-refundable administration fee of 500€ at the latest on or before «Zahlungsfrist_für_AAF». This fee includes the Application proofing for GVET (200€) as well as Ministry approval for your school certificate (300€). We are unable to issue your Original Admission letter for the PVP & Vocational training contract cannot be obtained by the candidate until a valid Certificate B1 (Goethe, Telc or Ösd) has been submitted, attend the PVP program online & other rules and regulations followed.
                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            Upon successfully passing the interview and selected for a Vocational training, a fee of 1000€ (non-refundable) is due and payable within 2 weeks from the date of selection. The remaining fee (3.500€) will be due within 7 days of a successful visa stamping & prior to landing in Germany.
                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            It is important that to start your GVET training a B2 level German is a must (Goethe, Telc or Ösd) and candidates must produce this (note: If B2 training is done online as a part of PVP course then initially only 500€ will be charged and deducted from the remaining fees of 3500€. The candidates have the choice to write the TELC B2 exam in Germany facilitated by the college). In case of not passing the TELC examination on time the GVET program cannot be started and the contract is void. Then the candidates need to complete the B2 examination on their own and also have the required living cost in need during the time.
                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            It is important to make sure your payment, your certificates and other necessary documents reaches us on time for a smooth admission & visa process and for you to join your course on time.
                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 border">
                        ...
                        <p>
                            ...
                            B) Transfer the non-refundable administration fee of 500€ <br>
                            C) A valid minimum B1 level German language certification & other relevant documents and rules are followed.<br>
                            D) Get selected for the Vocational training, pay non-refundable fees of 1000€<br>
                            And to start the pre vocational program in Germany:<br>
                            E) Make total fees payment of (3500€) towards your course fees within 7 days of successful Visa stamping & before arrival in Germany. If B2 langauge done online then (500€ before starting the B2 class) and 3000€ towards your course fees within 7 days of successful Visa stamping & before arrival in Germany.<br>
