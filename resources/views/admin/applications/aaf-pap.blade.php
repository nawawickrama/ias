...
<head>
    ...
    <title>Admission Acceptance Form</title>
        ...
        <divv class="card">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            ...
                            Thank you very much for your recent application (T2021) for the German Vocational Education and Training (GVET) AZUBI program offered by IAS College in cooperation with partners. We are pleased to inform you that your application & admission to the GVET program has been successful and that you have received the following offer:
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            Offer Status: Conditional <br>
                            Course: GVET 3.5 <br>
                            Course Field: Azp2022 <br>
                            Course Fee: 5000€
                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            Duration: 6 months Pre vocational program (PVP)-A GVET based training + 3 years of Vocational Education Training. Please do sign and return the acceptance form within 7 days. If you have any queries regarding this offer please feel free to contact us by Email admissions@iaos.de. The PVP is done either parallel to your GVET or in prior to start of your GVET training.
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            Once you have accepted your admission offer, we require you to pay the non-refundable administration fee of 1.000€ at the latest on or before «Zahlungsfrist_für_AAF». The remaining fee (4.000€) will be due within 7 days of a successful visa stamping & prior to landing in Germany. We are unable to issue your Original Admission letter for the PVP, German ministry approval & Vocational training contract cannot be obtained by the candidate until a valid Certificate B1 (Goethe, Telc or Ösd) has been submitted & other rules and regulations followed. It is important that to start your GVET training a B2 level German is a must (Goethe, Telc or Ösd) and candidates must produce this. It is important to make sure your payment, your certificates and other necessary documents reaches us on time for a smooth admission & visa process and for you to join your course on time.
                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <p>
                            Details regarding your course start date, travel, Insurance and accommodation will be sent to you along with the Admission letter for PVP.
                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 border">
                        <p class="mt-4">
                            To receive your original duly signed Admission letter to obtain German ministry approval, vocational training contract you will need to:-
                        </p>
                        <p>
                            A) Complete and return this Admission Acceptance Form (AAF). <br>
                            B) Transfer the non-refundable administration fee of 1.000€<br>
                            C) A valid minimum B1 level German language certification & other relevant documents and rules are followed.<br>
                            And to start the pre vocational program in Germany:<br>
                            D) Make total fees payment of 4.000€ towards your course fees within 7 days of successful Visa stamping & before arrival in Germany.<br>
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <p class="mt-4">
                            <b>2)</b> The duly signed admission letter for the program you have been admitted, ministry approval and the Vocational contract will be sent as an Email (PDF Copy). If in need of original letters, then for a fee (courier Charges) the letters will be posted to candidate’s address as given in their given in the Candidate Profile Form (CPF). In case of a change the candidate must provide prior notification.
                        ...
                        <p class="mt-4">
                            <b>3)</b> Original Admission letter for the PVP- a curriculum designed based on the GVET training, German ministry approval & Vocational training contract cannot be obtained until a valid Certificate B1 (Goethe, Telc or Ösd), required communication skills, other relevant documents are ready and the required process must be followed (like Notarization, Interview etc. & other success oriented rules and regulations). This B1 certificate must be provided minimum 2 months prior to start of the program in Germany. The B1 certificate must not be more than 6 months old (in case the certain modules were passed on different dates, the first module exam pass date will be considered). Language Level evaluation tests from IAS college is also possible to ensure the B1 language level if the candidate cannot provide a new B1 certificate from Goethe, Telc or Ösd.
                            <br> In case of not able to join the semester or the year for which this AAF has been provided, candidates are eligible for the immediate next intake for an additional administration fee of 150 Euros. Admission to any further intakes the candidate must reapply again. It is important that to start the GVET training a B2 level German is a must (Goethe, Telc or Ösd) and candidates must produce this.
                        </p>
                        <p class="mt-4">
                        ...
                        <p class="mt-4">
                           ...
                           <br> All refunds will be made to the bank and account holder (or other financial institution) that originally paid the fee unless otherwise the candidate gives in writing or by email a different bank account. Refunds are not made in cash.
                        ...
                        <p class="mt-4">
                            <b>12)</b> Cancellation by us: We reserve the right to cancel any course by giving you notice in writing at any time before the course is due to start or during the course. College will refund the rest non-used tuition fees (If an ongoing course has to be terminated) and or will endeavor to offer a transfer to another course as an alternative, subject to payment or refund of any difference in the fees as applicable.
                        </p>
                        <p class="mt-4">
                            <b>13)</b> The College & its partners may take visual and/or audio recordings of candidates, emails & contact details or email forwards from candidates before, after or during the course and reserve the right to use these for administrative, management, promotional, or educative purposes (in Germany and overseas). It is understood that the Candidate’s individual consent for this purpose is granted unless otherwise indicated by student/candidate in writing or by email prior to the start of the course. Those already in use or used will be unaffected.
                        </p>
                        <p class="mt-4">
