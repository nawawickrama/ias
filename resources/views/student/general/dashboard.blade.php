...
<div class="alert alert-icon-primary" role="alert">
    ...
    <hr>
    <br>
    <p class="text-dark"><i class="link-icon text-success" data-feather="check-circle"></i> Complete your student information <a href="{{route('information')}}">here</a>.</p>
    <p class="text-dark mt-4"><i class="link-icon text-primary" data-feather="alert-circle"></i> Upload the required documents <a href="{{route('documents')}}">here</a>.</p>
