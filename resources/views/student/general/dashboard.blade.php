...
<div class="alert alert-icon-primary" role="alert">
    ...
    <p class="text-dark mt-4">@if($documentCourse != null && $isDocumentsComplete)<i class="link-icon text-success" data-feather="check-circle"></i> Completed upload required documents. @else<i class="link-icon text-danger" data-feather="x-circle"></i> Upload the required documents <a href="{{route('candidateDocument')}}">here</a>.@endif</p>
