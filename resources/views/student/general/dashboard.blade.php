...
<div class="alert alert-icon-primary" role="alert">
    ...
    <p class="text-dark mt-4">@if($isPaymentComplete)<i class="link-icon text-success" data-feather="check-circle"></i> Completed Payments @else<i class="link-icon text-danger" data-feather="x-circle"></i> Complete the payments <a href="{{route('payments-manager')}}">here</a>.@endif</p>
</div>
