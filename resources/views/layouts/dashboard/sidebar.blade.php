...
<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
                    ...
                    <a class="nav-link" data-toggle="collapse" href="#emails" role="button" aria-expanded="false"
                       aria-controls="emails" id="req-ex">
                        ...
                        <div class="text-white invisible pendingCPF" role="status">
                            <span
                                class="badge badge-light badge-pill bg-warning text-black text-header-pendingCPF"></span>
                        </div>
                        <i class="link-arrow" data-feather="chevron-down" id="toggle-indicator"></i>
                    </a>
            ...
            <li class="nav-item">
                <a href="{{ route('potential-students') }}" class="nav-link">
                    ...
                    <div class="text-white invisible potentialStudent" role="status">
                        <span
                            class="badge badge-light badge-pill bg-warning text-black text-header-potentialStudent"></span>
                    </div>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{{ route('document-verification') }}" class="nav-link">
                    ...
                    <div class="text-white invisible pendingDocument" role="status">
                        <span
                            class="badge badge-light badge-pill bg-warning text-black text-header-pendingDocument"></span>
                    </div>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="{{ route('admin-payments-manager') }}" class="nav-link">
